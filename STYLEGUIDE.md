...
Things listed here are specific to Phoenix and likely only apply to this project

## Modules

Phoenix uses AMD modules to organize code, and require.js to load those modules.
